...
Button groups can contain buttons, icon buttons, radio controls (appropriately wrapped), and/or checkbox controls (appropriately wrapped).

Button groups apply shape, motion, and width changes to buttons/button-representations and icon buttons to make them more interactive.

Tokens & Specs (from https://m3.material.io/components/button-groups/specs)
...
18dp
Pressed
Button group xsmall pressed motion spring dampening
md.comp.button-group.standard.xsmall.pressed.item.width.motion.spring.dampening
0.9
Button group xsmall pressed motion spring stiffness
...
12dp
Pressed
Button group small pressed motion spring dampening
md.comp.button-group.standard.small.pressed.item.width.motion.spring.dampening
0.9
Button group small pressed motion spring stiffness
...
8dp
Pressed
Button group medium pressed motion spring dampening
md.comp.button-group.standard.medium.pressed.item.width.motion.spring.dampening
0.9
Button group medium pressed motion spring stiffness
...
8dp
Pressed
Button group large pressed motion spring dampening
md.comp.button-group.standard.large.pressed.item.width.motion.spring.dampening
0.9
Button group large pressed motion spring stiffness
...
8dp
Pressed
Button group xlarge pressed motion spring dampening
md.comp.button-group.standard.xlarge.pressed.item.width.motion.spring.dampening
0.9
Button group xlarge pressed motion spring stiffness
...
2dp
Button group connected small container shape
...
2dp
Button group connected medium container shape
...
2dp
Button group connected large container shape
