# M3 Tabs — Tokens & Specs

> Source: [m3.material.io/components/tabs/specs](https://m3.material.io/components/tabs/specs)
...
| Primary navigation tab container shape | `md.comp.primary-navigation-tab.container.shape` | md.sys.shape.corner.none |
...
| Primary navigation tab container elevation | `md.comp.primary-navigation-tab.container.elevation` | md.sys.elevation.level0 |
...
> **Label text type style:** Font Roboto 500, 14pt, tracking 0.1pt, line-height 20pt
...
| Primary navigation tab active indicator shape | `md.comp.primary-navigation-tab.active-indicator.shape` | 3dp 3dp 0 0 |
...
| Secondary navigation tab container shape | `md.comp.secondary-navigation-tab.container.shape` | md.sys.shape.corner.none |
| Secondary navigation tab container height | `md.comp.secondary-navigation-tab.container.height` | 48dp |
| Secondary navigation tab container elevation | `md.comp.secondary-navigation-tab.container.elevation` | md.sys.elevation.level0 |
...
The active-tab indicator should exist outside of the tab button itself and should animate (horizontally) to the position (and inline scale) of the active-tab.
