...
export const EzRippleName = 'ez-ripple';
...
const _mouseOverEventName = 'mouseenter',
  ...
  _rippleDiameterCssPropName = `--${EzRippleName}-diameter`,
  _rippleXCssPropName = `--${EzRippleName}-x`,
  _rippleYCssPropName = `--${EzRippleName}-y`,
  /**
   * @param {Event} e
...
export class EzRippleElement extends HTMLElement {
  static localName: string = EzRippleName;
  ...
  get localName() {
    return (
      (this.constructor as unknown as EzRippleElement).localName ?? EzRippleName
    );
  }
