import { fib, factorsOf } from '@atomic/ui/utils';
  ...
  return (
    <section>
      ...
      <article>
        <div>
          <p>
            The library&lsquo;s spacing properties - factors of 144, and the
            fibonacci sequence, combined, in ordered sequence, represented as
            &grave;rem&grave; units (in source).
          </p>
        </div>
