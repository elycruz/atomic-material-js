...
export default function RipplePage() {
  return (
    <section>
      ...
      <div>
        <p>
          An element that provides the material-design ripple effect, for user
          interactions, within/on UI components.
        </p>
        <p>The element operates in two modes:</p>
        <ul>
          <li>With children (e.g., with a checkbox input), and</li>
          <li>
            As an &quot;empty&quot; child element (within a button element,
            etc.).
          </li>
        </ul>
        ...
        <ul>
          <li>
            When the elements is used as an empty element, within an interactive
            element, the interactive element should contain a{' '}
            <code>position</code> value; E.g., <code>position: relative;</code>{' '}
            etc.
          </li>
        </ul>
        <dl>
          ...
          <dd>
            <p>
              With <code>position: relative;</code>:
            </p>
            <div
              className={`${styles['standalone-ripple']} ez-theme-neutral`}
          ...
          <dd>
            <button type="button" className="ez-btn ez-filled ez-theme-neutral">
              <EzRippleComponent></EzRippleComponent>
              <span>Button</span>
            </button>
          </dd>
